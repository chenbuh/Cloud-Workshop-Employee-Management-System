  ...
  <div class="contract-container">
    ...
    <n-form-item label="电子存档">
           <n-upload
               ...
               @remove="formValue.fileUrl = ''"
           >
               <n-button>上传扫描件 (PDF/图片)</n-button>
           </n-upload>
           <div v-if="formValue.fileUrl" style="margin-left: 10px; color: #10b981">
...
const handleUploadFinish = ({ file, event }: any) => {
    ...
    if (res.code === 200) {
        formValue.value.fileUrl = res.data
